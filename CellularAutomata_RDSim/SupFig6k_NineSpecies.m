...
SS_P.Reps=100;
SS_Init=zeros(size(SS_In,1),size(SS_In,2),nSpecies);
%Conc. Tubulin for 5 Spec 11.53µM
SS_Init(:,1)=20*Msk_Int;
...
title('9 Species, 20µM tubulin')
Data_9Spec_20microM=Data;
Data_pStat(:,4)=sum(Data(:,[3 5 7 9]),2);
print('SupFig_6_9Species','-dsvg','-r0')