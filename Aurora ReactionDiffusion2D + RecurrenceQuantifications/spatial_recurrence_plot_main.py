import numpy as np
import os
import spatial_recurence_plot_quantifications as rpq
import pandas as pd
...
if __name__=='__main__':
    ...
    Entropy_estimation_at=[0, 272000]
